...
struct StoryBrain {
    ...
    mutating func switchToStory(storyNumber: Int) {
        self.storyNumber = storyNumber
    }
    
    mutating func nextStory(userChoice: String) {
        if userChoice == stories[storyNumber].choice1 {
            switchToStory(storyNumber: stories[storyNumber].choice1Destination)
        } else if userChoice == stories[storyNumber].choice2 {
            switchToStory(storyNumber: stories[storyNumber].choice2Destination)
        }
    }
